  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">Welcome to FlowAdmin. Here's what's happening today.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+180 new clients</p>
          </CardContent>
        </Card>
        ...
        <Card className="col-span-4">
          ...
          <CardContent>
            <div className="h-[300px] flex items-center justify-center border-2 border-dashed rounded-md bg-gray-50/50 dark:bg-gray-800/50">
              <span className="text-sm text-gray-500">Activity chart will go here</span>
            </div>
          </CardContent>
        </Card>
             ...
             <div className="space-y-8">
                <div className="flex items-center">
                  <div className="ml-4 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">Invoice #10023</p>
                  </div>
                  <div className="ml-auto font-medium">+$1,999.00</div>
                </div>
                <div className="flex items-center">
                  <div className="ml-4 space-y-1">
                    <p className="text-sm font-medium leading-none">Globex Inc</p>
                    <p className="text-sm text-muted-foreground">Invoice #10022</p>
                  </div>
                  <div className="ml-auto font-medium">+$399.00</div>
                </div>
                <div className="flex items-center">
                  <div className="ml-4 space-y-1">
                    <p className="text-sm font-medium leading-none">Soylent Corp</p>
                    <p className="text-sm text-muted-foreground">Invoice #10021</p>
                  </div>
